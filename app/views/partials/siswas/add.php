                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-nis"  value="<?php  echo $this->set_field_value('nis',""); ?>" type="number" placeholder="Enter Nis" step="1"  required="" name="nis"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-jenis_kelamin"  value="<?php  echo $this->set_field_value('jenis_kelamin',"laki-laki"); ?>" type="text" placeholder="Enter Jenis Kelamin"  required="" name="jenis_kelamin"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-golongan_darah"  value="<?php  echo $this->set_field_value('golongan_darah',"A"); ?>" type="text" placeholder="Enter Golongan Darah"  required="" name="golongan_darah"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <input id="ctrl-tinggi_badan"  value="<?php  echo $this->set_field_value('tinggi_badan',""); ?>" type="number" placeholder="Enter Tinggi Badan" step="1"  required="" name="tinggi_badan"  class="form-control " />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                                    <input id="ctrl-berat_badan"  value="<?php  echo $this->set_field_value('berat_badan',""); ?>" type="number" placeholder="Enter Berat Badan" step="1"  required="" name="berat_badan"  class="form-control " />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group ">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <div class="">
                                                                                        <input id="ctrl-nama_ayah"  value="<?php  echo $this->set_field_value('nama_ayah',""); ?>" type="text" placeholder="Enter Nama Ayah"  required="" name="nama_ayah"  class="form-control " />
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group ">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-8">
                                                                                        <div class="">
                                                                                            <input id="ctrl-nama_ibu"  value="<?php  echo $this->set_field_value('nama_ibu',""); ?>" type="text" placeholder="Enter Nama Ibu"  required="" name="nama_ibu"  class="form-control " />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
