                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-golongan_darah"> Golongan Darah</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-golongan_darah">
                                                        <span  data-value="<?php echo $data['golongan_darah']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("siswas/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="golongan_darah" 
                                                            data-title="Enter Golongan Darah" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
                                                    ...
                                                    <td class="td-tinggi_badan">
                                                        <span  data-value="<?php echo $data['tinggi_badan']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("siswas/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="tinggi_badan" 
                                                            data-title="Enter Tinggi Badan" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="number" 
                                                            data-mode="popover" 
                                                    ...
                                                    <td class="td-berat_badan">
                                                        <span  data-value="<?php echo $data['berat_badan']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("siswas/editfield/" . urlencode($data['id'])); ?>" 
                                                    ...
                                                    <td class="td-nama_ayah">
                                                        <span  data-value="<?php echo $data['nama_ayah']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("siswas/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="nama_ayah" 
                                                    ...
                                                    <td class="td-nama_ibu">
                                                        <span  data-value="<?php echo $data['nama_ibu']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("siswas/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="nama_ibu" 
