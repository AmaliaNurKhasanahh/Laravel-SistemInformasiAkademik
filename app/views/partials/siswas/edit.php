                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-nis"  value="<?php  echo $data['nis']; ?>" type="number" placeholder="Enter Nis" step="1"  required="" name="nis"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <input id="ctrl-tinggi_badan"  value="<?php  echo $data['tinggi_badan']; ?>" type="number" placeholder="Enter Tinggi Badan" step="1"  required="" name="tinggi_badan"  class="form-control " />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                                    <input id="ctrl-berat_badan"  value="<?php  echo $data['berat_badan']; ?>" type="number" placeholder="Enter Berat Badan" step="1"  required="" name="berat_badan"  class="form-control " />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
