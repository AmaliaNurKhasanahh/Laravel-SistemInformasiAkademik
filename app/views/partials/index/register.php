                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <label class="control-label" for="mengajar">Mengajar <span class="text-danger">*</span></label>
                                                        </div>
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-mengajar"  value="<?php  echo $this->set_field_value('mengajar',""); ?>" type="text" placeholder="Enter Mengajar"  required="" name="mengajar"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-role"  value="<?php  echo $this->set_field_value('role',"1"); ?>" type="number" placeholder="Enter Role" step="1"  required="" name="role"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
