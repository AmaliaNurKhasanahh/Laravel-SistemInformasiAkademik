...
class UsersController extends SecureController{
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("name","email","email_verified_at","password","mengajar","kelas","role","remember_token","created_at","updated_at","deleted_at","photo");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","name","email_verified_at","mengajar","kelas","role","remember_token","created_at","updated_at","deleted_at","photo");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'name' => 'required',
